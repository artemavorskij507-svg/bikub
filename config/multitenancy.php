...
return [
    ...
    'not_tenant_aware_jobs' => [
        \App\Domain\AgentOS\Jobs\ProcessAgentRunJob::class,
        \App\Domain\AgentOS\Jobs\DetectStaleAgentStepsJob::class,
        \App\Domain\AgentOS\Jobs\CompactAgentMemoriesJob::class,
    ],
];
