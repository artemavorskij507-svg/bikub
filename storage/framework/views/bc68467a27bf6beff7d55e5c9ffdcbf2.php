...
} elseif ($_instance->childHasBeenRendered('AcHKfIA')) {
    $componentId = $_instance->getRenderedChildComponentId('AcHKfIA');
    $componentTag = $_instance->getRenderedChildComponentTagName('AcHKfIA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AcHKfIA');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('AcHKfIA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('4eaVrjc')) {
    $componentId = $_instance->getRenderedChildComponentId('4eaVrjc');
    $componentTag = $_instance->getRenderedChildComponentTagName('4eaVrjc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4eaVrjc');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('4eaVrjc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/bikube/vendor/filament/filament/resources/views/components/topbar.blade.php ENDPATH**/ ?>