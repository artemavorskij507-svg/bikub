...
@php
  ...
  $desc  = $service->short_description ?? $service->description ?? 'Короткий опис послуги';
  $price = null;
...
<a href="{{ $href }}"
   class="group block rounded-3xl overflow-hidden ring-1 ring-slate-200/80 bg-white/80 backdrop-blur hover:shadow-xl hover:ring-sky-200 transition-transform duration-300 hover:-translate-y-1">
  ...
  <div class="p-5">
    ...
    <div class="mt-4 flex items-center gap-2 text-sky-700">
